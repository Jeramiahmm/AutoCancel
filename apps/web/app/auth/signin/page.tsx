  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#09090b] text-white">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -left-32 top-0 h-[500px] w-[500px] rounded-full bg-[radial-gradient(circle,rgba(139,92,246,0.15)_0%,transparent_70%)] blur-3xl" />
        <div className="absolute right-[-120px] top-40 h-[400px] w-[400px] rounded-full bg-[radial-gradient(circle,rgba(6,182,212,0.1)_0%,transparent_70%)] blur-3xl" />
      </div>
        ...
        <section className="relative z-10 space-y-6">
          ...
          <div className="grid gap-3 text-sm text-zinc-400">
            <div className="inline-flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] px-3 py-2">
              <ShieldCheck className="size-4 text-violet-400" strokeWidth={1.6} />
              OAuth-only integrations with encrypted tokens
            </div>
            <div className="inline-flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] px-3 py-2">
              <Lock className="size-4 text-violet-400" strokeWidth={1.6} />
