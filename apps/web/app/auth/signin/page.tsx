  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#0a0c0f] text-white">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -left-32 top-0 h-[500px] w-[500px] rounded-full bg-[radial-gradient(circle,rgba(16,185,129,0.06)_0%,transparent_70%)] blur-3xl" />
        <div className="absolute right-[-120px] top-40 h-[400px] w-[400px] rounded-full bg-[radial-gradient(circle,rgba(52,211,153,0.04)_0%,transparent_70%)] blur-3xl" />
      </div>
      ...
      <div className="mx-auto grid min-h-screen w-full max-w-6xl items-center gap-10 px-4 py-10 md:px-6 lg:grid-cols-[1.05fr_0.95fr]">
        <section className="relative z-10 space-y-6">
          <span className="inline-flex items-center gap-2 rounded-full border border-white/[0.08] bg-white/[0.05] px-3 py-1 text-xs uppercase tracking-[0.2em] text-zinc-400">
            <ShieldCheck className="size-3.5 text-emerald-400" strokeWidth={1.5} />
            Secure Access
          </span>
          ...
          <div className="grid gap-3 text-sm text-zinc-400">
            <div className="inline-flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] px-3 py-2">
              <ShieldCheck className="size-4 text-emerald-400" strokeWidth={1.6} />
              OAuth-only integrations with encrypted tokens
            </div>
            <div className="inline-flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] px-3 py-2">
              <Lock className="size-4 text-emerald-400" strokeWidth={1.6} />
