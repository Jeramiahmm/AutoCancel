...
export function SignInCard({
  ...
  return (
    <Card className="w-full border-white/[0.1] bg-white/[0.05] shadow-glow backdrop-blur-2xl">
      <CardHeader>
        <CardTitle className="text-2xl">Welcome to AutoCancel</CardTitle>
        <p className="text-sm text-zinc-400">Secure by design, no email passwords required.</p>
      </CardHeader>
      <CardContent className="space-y-5">
        ...
        {googleEnabled ? (
          <Button
            variant="outline"
            className="w-full border-white/[0.1] bg-white/[0.05] hover:bg-white/[0.08]"
